...
def chunk_and_tag_crus(
    ...
    if application_domain not in APPLICATION_DOMAINS:
        print(f"[WARNING]️  WARNING: '{application_domain}' not in APPLICATION_DOMAINS")
    ...
    print(f"[OK] Loaded {len(crus)} CRUs")
    ...
    if not validation_report["all_crus_present"]:
        print(f"[WARNING]️  WARNING: Not all CRUs present in chunks!")
    ...
    if validation_report["size_limit_violated"]:
        print(f"[WARNING]️  WARNING: Chunk size limit violated!")
    ...
    if not validation_report["domain_consistency"]:
        print(f"[WARNING]️  WARNING: Inconsistent application domains across chunks!")
