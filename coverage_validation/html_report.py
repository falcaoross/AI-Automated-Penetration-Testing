# html_report.py - AI Pentest CAU Layer
...
<title>AI Pentest - CAU Traceability Report</title>
<style>
...
def _gap_section(gaps: dict) -> str:
    ...
    parts = ['<section id="gap-report">', '<h2 class="section-title">Traceability Gap Report</h2>']
