...
class TestCaseValidationEngine:
    ...
    def validate_all(self, test_cases: List[Dict], requirements: List[Dict]) -> Dict:
        ...
        print(f"  [OK] HIGH (0.8-1.0):          {high_conf_count:>4} ({high_conf_count/len(test_cases)*100:.1f}%)")
    ...
    def export_validation_report(self, summary: Dict, output_file: str):
        ...
        print(f"[OK] Validation report saved: {output_file}")
...
def main():
    ...
    TEST_CASES_FILE = "../04_AI_powered_TestCaseGeneration/AI_Pentest_Report_OWASP_20251017_000535.json"
    ...
    print(" " * 25 + "[OK] VALIDATION COMPLETE!")
