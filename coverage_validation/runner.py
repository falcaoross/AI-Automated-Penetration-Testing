...
# runner.py - AI Pentest CAU Layer
...
#     --tests    path/to/AI_Pentest_Report_OWASP.json \
...
def run_pipeline(
    ...
    logger.info("=== AI Pentest CAU Layer - START ===")
    ...
    logger.info("=== AI Pentest CAU Layer - DONE ===")
...
def _parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        description='AI Pentest CAU Layer - UAT -> CRU -> Test Case Traceability Pipeline',
    ...
    parser.add_argument(
        ...
        help='Path to AI_Pentest_Report_OWASP.json',
