"""
runner.py - Pipeline orchestrator for the AI Pentest Ingestion Engine.
...
def _print_audit(
    ...
    print()
    print(_divider("="))
    print(f"  AI PENTEST INGESTION REPORT  -  {doc_meta['doc_id']}")
    print(_divider("="))
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="runner.py",
        description=(
            "AI Pentest Ingestion Engine - Layer 1 pipeline runner.\n"
