...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--timeout",     default=600.0, type=float,         help="LLM request timeout (seconds).")
    return parser
...
def main() -> None:
    ...
    if len(failed_groups) > 0:
        print(f"  [DONE] Completed with {len(failed_groups)} failures. Proceeding with successfully extracted requirements.")
