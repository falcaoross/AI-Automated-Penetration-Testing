"""
compare_graphrag.py  (updated — adds test_diff command)
=========================================================
Three sub-commands:
...
python compare_graphrag.py snapshot --db graphrag/output/graphrag.duckdb --req-id CRU-FR10-01 --label before --out comparison/
python compare_graphrag.py snapshot --db graphrag/output/graphrag.duckdb --req-id CRU-FR10-01 --label after  --out comparison/

# Generate the before/after overview report
python compare_graphrag.py report --before comparison/snapshot_before.json --after comparison/snapshot_after.json --out comparison/comparison_report.html

# NEW: dump every new test case with full details
python compare_graphrag.py test_diff \
