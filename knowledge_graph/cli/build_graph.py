"""
knowledge_graph/cli/build_graph.py
=============================
FIX SUMMARY:
...
from knowledge_graph.builders.cru_builder import build_cru_nodes
from knowledge_graph.builders.chunk_builder import build_chunk_nodes
from knowledge_graph.builders.test_builder import build_test_nodes
from knowledge_graph.builders.edge_builder import (
...
def main():
    ...
    try:
        ...
        if errors > 0:
            print("[BUILD] [WARNING]️  Integrity errors found - review rag_integrity_report.json")
