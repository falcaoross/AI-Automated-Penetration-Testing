"""
knowledge_graph/cli/query_graph.py
=============================
...
from knowledge_graph.generation.test_generator import generate_tests_from_context_pack
from knowledge_graph.models.contracts import AcceptanceDecision, OpenQuestion
...
def main():
    ...
    parser.add_argument(
        "--task", required=True,
        choices=["test_generation", "debug", "impact", "coverage_validation"],
    )
    ...
    try:
        ...
        if args.rebuild_emb:
            from knowledge_graph.vector.vector_index import build_embeddings  # noqa: PLC0415
        ...
        if should_trigger_vector_fallback(graph_result):
            ...
            from knowledge_graph.retrieval.vector_fallback import vector_search  # noqa: PLC0415
        ...
        elif args.task == "coverage_validation":
        ...
        print(f"[OK] Context Pack saved: {args.out}")
