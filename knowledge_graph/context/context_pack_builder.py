"""
knowledge_graph/context/context_pack_builder.py
==========================================
...
from knowledge_graph.context.trace_paths import build_trace_paths
from knowledge_graph.context.warnings_builder import build_warnings
from knowledge_graph.models.contracts import (
    Anchor,
    ContextPack,
    EvidenceChunk,
    OpenQuestion,
...
from knowledge_graph.retrieval.parent_context import attach_parent_context
