...
!git clone https://github.com/YOUR_USERNAME/AI-Pentest-Gen.git /content/AI-Pentest-Gen

# Option B: if the project is already on your Google Drive
import shutil
shutil.copytree('/content/drive/MyDrive/AI-Pentest-Gen', '/content/AI-Pentest-Gen')
```

Navigate into the project root:
```python
%cd /content/AI-Pentest-Gen
```
...
5. [DONE] You are now inside the AI Pentest Engine UI!
...
4. Watch the pipeline run through all 5 stages automatically:
   - [OK] Document Parsing
   - [OK] Requirement Analysis
   - [OK] Requirement Units Structuring
   - [OK] Segmentation & Classification
   - [OK] Testcase Generation (this is the longest step - typically 5-20 mins depending on the model)
