...
FAST_MODEL = os.environ.get("OLLAMA_MODEL", "llama3:8b")

DEEP_MODEL = os.environ.get("OLLAMA_MODEL", "llama3:8b")
...
class OptimizedHybridEngine:
    ...
    def __init__(self, model_name: str = "llama3:8b", prompts_file: str = "prompts.json"):
        ...
        self.client = ollama.Client(timeout=600.0)
        ...
        print(f"[OK] Prompts loaded from: {prompts_file}")
...
class OptimizedHybridGenerator:
    ...
    def save_results(self, output_prefix: str = "AI_Pentest_Report_OWASP"):
        ...
        if df.empty:
            ...
            print("[WARNING]️ Warning: No test cases generated. Creating empty report.")
        ...
        with open(summary_file, 'w') as f:
            ...
            f.write("AI PENTEST ENGINE - OWASP SECURITY REPORT\n")
...
def main():
    ...
    OUTPUT_PREFIX = "../Testcase_Generation/output/AI_Pentest_Report_OWASP"
